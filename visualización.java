 ...
 JLabel lbs[]= new JLabel[9];
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(visualización.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
